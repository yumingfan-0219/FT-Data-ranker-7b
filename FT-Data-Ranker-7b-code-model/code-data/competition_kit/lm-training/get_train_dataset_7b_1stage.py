...
TOKEN_NUMS = 10000000
RATIO = 0.65
EN_DATA_DIR = "/work/cache/paper_zhuanli_game/competition_kit/data/raw_data/raw_data_en-bloom-c4.jsonl"
ZH_DATA_DIR = "/work/cache/paper_zhuanli_game/competition_kit/data/raw_data/raw_data_zh_bloom.jsonl"


OUTPUT_FILES = "/work/cache/paper_zhuanli_game/competition_kit/data/train_data/train_bloom-c4.json" 
...
#/work/share/public/weights/baichuan2-7b-modelscope/base   baichuan-inc/Baichuan2-7B-Base
enc = AutoTokenizer.from_pretrained("/work/cache/paper_zhuanli_game/competition_kit/models/Baichuan2-7B-Base", use_fast=False, trust_remote_code=True)
...
for i in tqdm(range(len(ds_en))):
    if 'a summary of the text' in ds_en[i]['instruction']:
        en_token_nums -= get_token_count(ds_en[i])
        selected_elements.append(ds_en[i]) 
